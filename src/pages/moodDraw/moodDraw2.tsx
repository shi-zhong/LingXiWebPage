...
const Chart1 = './static/chart3.png';
const Chart2 = './static/chart4.png';
      ...
      <div className={prefix + 'analysis'}>
        ...
        <div className={prefix + 'analysis-content'}>
          <p className="p">
            ...
            <span style={style}>乱贴标签</span>、
            <span style={style}>哀伤与丧失</span>、
            <span style={style}>缩小</span>和<span style={style}>罪责归己</span>
            的特征。
          </p>
          <p className="p">
          ...
          <p className="p">
            而<span style={style}>缩小</span>
            则意味着主人过于忽视了自己的<span style={style}>主观能动性</span>
            ，长期如此，会造成自我效能感的缺失
          </p>
        </div>
